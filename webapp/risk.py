...
# ข้างล่างให้ต่ำลงในอนาคต ค่าตารางชุดปัจจุบันคูณกันแล้วต่ำสุดได้ 0.80 x 0.82 x 0.93 = 0.61 ยังไม่แตะพื้นนี้
...
def _cv_factor(cv: float | None) -> tuple[float, str]:
    ...
    return 0.82, f"ราคาในกลุ่มกระจายกว้างมาก (CV {cv:.2f}) — ค่าเฉลี่ยแทนกลุ่มได้ไม่ดี"
